    ...
    <section id="Section-6">
      ...
      <div className="container">
        <div className="row sec-2-h-wrapper">
          ...
          <div className="col-lg-5 col-md-12">
            <p className="title-p">Our interior design project revolves around transforming a residential space into a modern and inviting oasis. With a focus on functionality and aesthetics.</p>
          </div>
        </div>
      </div>
              ...
              <div className="col-lg-12">
                <div className="project-style-two-title-main-wrapper">
                  <div className="pagination-left-banner-one">
                    <div className="activeslide">{String(active).padStart(2, "0")}</div>
                    <div className="swiper-paginations"></div>
                    <div className="totalslide">{String(slides.length).padStart(2, "0")}</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col-lg-12">
                <div className="main-product-wrapper-two">
                    ...
                    {slides.map((s, idx) => (
                      <SwiperSlide key={`img-${idx}`}>
                        <div className="single-product-wrapper-two">
                          <img src={s.img} alt={`${s.title} ${s.subtitle}`} width="100%" />
                        </div>
                      </SwiperSlide>
                    ))}
                  </Swiper>
                  ...
                  <div className="portfolio-outer-text-swiper-wrapper">
                    <Swiper modules={[Controller]} onSwiper={setTextSwiper} controller={{ control: mainSwiper }} slidesPerView={1} allowTouchMove={false} className="mySwiper-product-OuterText-2">
                      {slides.map((s, idx) => (
