...
export default function AboutSection2() {
  return (
    <section id="aboutSection-2">
      <div className="about-sec-2-wrapper">
            ...
            <div className="col-md-4">
              <div>
                ...
                <div className="abt-sec-2-img-wrap">
                  <img src={aboutImg2} width="100%" alt="About Us" />
                </div>
              </div>
            </div>
            ...
            <div className="col-md-8">
              <div>
                ...
                <div className="abt-sec-2-img2-wrap">
                  <img src={aboutImg1} width="100%" alt="About Illustration" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="about-sec-2-row-2">
        <div className="container">
          <div className="row justify-content-between about-sec2-r-2-align">
            <div className="col-lg-3 col-md-4">
              <div>
                <h1 className="abt-sec-2-num">360k</h1>
                <p>Award Winning</p>
              </div>
            </div>
            <div className="col-lg-3 col-md-4">
              <div>
                <h1 className="abt-sec-2-num">160+</h1>
                <p>Project Done</p>
              </div>
            </div>
            <div className="col-lg-3 col-md-4">
              <div>
                <h1 className="abt-sec-2-num">200+</h1>
                <p>Award Winning</p>
              </div>
            </div>
            <div className="col-lg-3 col-md-4">
              <div>
                <h1 className="abt-sec-2-num">100k</h1>
                <p>Year Experience</p>
              </div>
            </div>
          </div>
